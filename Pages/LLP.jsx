      ...
      <main>
        <div className="herocontainer">
          ...
          <section className="contact-form">
            ...
            <h2 className="formplctitle text-center">Limited Liability partnership</h2>
          ...
          <div className="hero-text herocontent">
            <h1 className="herotitle">Get your LLP Registered @ ₹3999/-</h1>
            <p className="heropara">You may be a sole proprietor, a partnership, or a company. But one thing is for sure, you want your business to be recognized in the market and create an impact by introducing it to as many people as possible. At Kalpa Tag, this becomes a reality by helping you get your limited liability partnership registered at just ₹ 3999/-*</p>
          </div>
        </div>
      </main>
          ...
          <div className="row align-items-center bg_white_box">
            <div className="col-lg-6 col-sm-12 col-12">
              <div className="help_txt">
                ...
                Limited Liability. Unlimited Partnership.
                </h2>
              </div>
            </div>
            <div className="col-lg-6 col-sm-12 col-12">
              <div className="help_txt">
                ...
                Limited Liability Partnership is the best of both worlds. It keeps all the benefits of a partnership firm and allows you to enjoy limited liability, so if things go wrong then your personal assets are safe. It's quick and easy to get your LLP registered with Kalpa Tag.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="padding-vertical padding-xhuge">
                <div className="row">
                  <div className="col-md-6 layout353_content-left">
                    <div>
                      <h2 className="heading-xxlarge sixreasonstitle">6 Reasons to choose LLP</h2>
                      <p className="text-size-large sixreasonspara">Here are the major reasons why people prefer LLP:</p>
                  ...
                  <div className="col-md-6  layout353_content-right">
                    <div className="layout353_content-item content-item-1 sticky">
                      ...
                      <div>
                        <h5>No requirement of minimum contribution</h5>
                      </div>
                    </div>
                    <div className="layout353_content-item content-item-2 sticky">
                      ...
                      <div>
                        <h5>No limit on owners of the business</h5>
                      </div>
                    </div>
                    ...
                    <div className="layout353_content-item content-item-4 sticky">
                      ...
                      <div>
                        <h5>No requirement of compulsory Audit</h5>
                      </div>
                    </div>
                    <div className="layout353_content-item content-item-5 sticky">
                      ...
                      <div>
                        <h5>Dividend Distribution Tax (DDT) not applicable</h5>
                      </div>
                    </div>
                    <div className="layout353_content-item content-item-6 sticky">
                      ...
                      <div>
                        <h5>Flexibility in fund management</h5>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="head_sec ">
            <div className="row align-items-center">
              <div className="col-lg-10 col-sm-12 ">
                <h2 className="criteriatitle">LLP Incorporation<br /> made easy!</h2>
          ...
          <div className="tab-content">
            <div className={`tab-pane ${activeTab === 'tabs-1' ? 'active' : ''}`} id="tabs-1" role="tabpanel">
              <div className="round_box criteriabox ms-auto bg-white">
                <li className="p_rel">✔ Forming an LLP requires at least two partners (no maximum number) </li>
                <li className="p_rel">✔ There is no concept of shared capital, but each partner has to contribute towards capital of LLP</li>
                <li className="p_rel">✔ DIN (Director Identification Number) for Designated Partners </li>
                <li className="p_rel">✔ DSC (Digital Signature Certificate) for Designated Partners</li>
              </div>
            </div>
            <div className={`tab-pane ${activeTab === 'tabs-2' ? 'active' : ''}`} id="tabs-2" role="tabpanel">
              <div className="bg-white criteriabox">
                <li><b>A.</b></li>
                <li><b>Designated Partner's Documents</b></li>
                <li className="p_rel">✔ Designated Partner's PAN</li>
                <li className="p_rel">✔ Designated Partner's ID Proofs</li>
                <li className="p_rel">✔ Aadhaar Card or Voter ID or Passport or Driver's License</li>
                <li className="p_rel">✔ Designated Partner's Address Proofs:</li>
                ...
                <li className="p_rel">✔ Designated Partner's latest passport size photograph</li>
                <li className="p_rel">✔ Designated Partner's Email ids</li>
                <li className="p_rel">✔ Designated Partner's Mobile Numbers linked with their Aadhar</li>
                <li className="p_rel">✔ Incase of Foreign designated partners, International Passport is mandatory</li>
                
                <li><b>B.</b></li>
                <li><b>LLP Documents</b></li>
                ...
                <li className="p_rel">✔ LLP email id.</li>

                
                <li><b>Documents required for partnership firm</b></li>
                <li className="p_rel">✔ ID and Address Proof of Partners like PAN Card/Passport/Voter ID/Aadhar Card/Driving License Copy of the Partners.</li>
                <li className="p_rel">✔ One Business Place Address proof :- if Property on Rented :- Need Rent Agreement and NOC from Landlord. if Property is own :- Need Electricity Bills or any other Address Proof. Note : Business place and home place can be same.</li>
              </div>
            </div>
