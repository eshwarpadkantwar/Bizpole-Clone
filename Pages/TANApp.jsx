      ...
      <main>
        <div className="herocontainer">
          ...
          <section className="contact-form">
            ...
            <h2 className="formplctitle text-center">TAN Application</h2>
          ...
          <div className="hero-text herocontent">
            <h1 className="herotitle">A unique number for tax: What is TAN?</h1>
            <p className="heropara">Tax Account Number (TAN) is a unique 10-digit alpha numeric number issued by the Income Tax Department of India. Businesses while deducting the salaries of employees must obtain and mention the number. TAN leads to creation of a master file in the IT department that keeps track of all your tax records, assessees and other related information.</p>
          </div>
        </div>
      </main>
          ...
          <div className="row align-items-center bg_white_box">
            <div>
              <div className="help_txt">
                ...
                <h6 className="mt-3">A TAN number is required for all organisations that withhold tax at source in order to carry out the deduction procedure on behalf of the government and make deposits to the appropriate account.</h6>
                <div className="text-left">
                    <li>a) Every person who is liable to deduct tax at source or collect tax at source.</li>
                    <li>b) Any company, proprietor, or government body that pays salaries, dividends, interests and commissions</li>
              ...
              <div className="padding-vertical padding-xhuge">
                <div className="row">
                  <div className="col-md-6 layout353_content-left">
                    <div>
                      <h2 className="heading-xxlarge sixreasonstitle">4 major reasons to get a TAN</h2>
                  ...
                  <div className="col-md-6  layout353_content-right">
                    <div className="layout353_content-item content-item-1 sticky">
                      ...
                      <div>
                        <h5>It provides a unique number with lifetime validity.</h5>
                      </div>
                    </div>
                    <div className="layout353_content-item content-item-2 sticky">
                      ...
                      <div>
                        <h5>TDS deduction is mandatory after specified limits of payments.</h5>
                      </div>
                    </div>
                    <div className="layout353_content-item content-item-3 sticky">
                      ...
                      <div>
                        <h5>Tax payee has an opportunity to know how much tax has been paid by them.</h5>
                      </div>
                    </div>
                    <div className="layout353_content-item content-item-4 sticky">
                      ...
                      <div>
                        <h5>Tax payee can use the TDS certificate as proof of tax paid.</h5>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="container criteriacontainer">
          <div className="head_sec ">
            <div className="row align-items-center">
              <div className="col-lg-10 col-sm-12 ">
                <h2 className="criteriatitle">Getting a TAN card<br /> made easy!</h2>
          ...
          <ul className="nav  nav-tabs criteriatabs me-auto" role="tablist">
            <li className="nav-item">
              <button className={`nav-link criteriabtn ${activeTab === 'tabs-1' ? 'active' : ''}`} onClick={() => handleTabClick('tabs-1')} role="tab">Documents Required</button>
            </li>
            <li className="nav-item">
          ...
          <div className="tab-content">
            <div className={`tab-pane ${activeTab === 'tabs-1' ? 'active' : ''}`} id="tabs-1" role="tabpanel">
              <div className="round_box criteriabox ms-auto bg-white">
                <li className="p_rel">✔ Address proof - Aadhaar card or other. </li>
                <li className="p_rel">✔ Applicant information</li>
                <li className="p_rel">✔ Certificate of incorporation </li>
                <li className="p_rel">✔ Agreement made for a partnership firm, LLP, etc.</li>
                <li className="p_rel">✔ Acknowledgement receipt</li>
              </div>
            </div>
            <div className={`tab-pane ${activeTab === 'tabs-2' ? 'active' : ''}`} id="tabs-2" role="tabpanel">
              <div className="bg-white criteriabox">
              <li><b>Step 1:</b> Visit the online portal Visit the Tax Information Network (TIN) online portal of the National Securities DepositoryVisit Limited (NSDL) department</li>
                    <li><b>Step 2:</b> Generate a new TAN form On the portal, opt for a 'New TAN’ and fill in the necessary details required for Form 49 B.</li>
                    <li><b>Step 3:</b> Submission of form Once you submit the form and complete the payment details, the display will show the details of the 14-digit unique acknowledgement number</li>
