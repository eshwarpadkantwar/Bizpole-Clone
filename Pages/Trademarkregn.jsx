        ...
        <div className="herocontainer">
          ...
          <section className="contact-form">
            ...
            <form className="actualform">
              <h2 className="formplctitle text-center">Trademark Registration</h2>
          ...
          <div className="hero-text herocontent">
            <h1 className="herotitle">Protect Your Brand</h1>
            <p className="heropara">Your business needs trademarks to identify its products or services, for brand loyalty and identity, and to distinguish it from competitors. A registered trademark will not only protect your name and logo from others using them inappropriately but also help you stand out from the crowd.</p>
          </div>
        </div>
      </main>
            ...
            <div className="col-lg-6 col-sm-12 col-12">
              <div className="help_txt">
                <p className="text-left color_white mt-3 banner2para">
                  <li>Product Mark</li>
                  <li className="mt-2">Service Mark</li>
                  <li className="mt-2">Collective Mark</li>
                  <li className="mt-2">Certification Mark</li>
                  <li className="mt-2">Shape Mark</li>
                  <li className="mt-2">Pattern Mark</li>
                  <li className="mt-2">Sound Mark</li>
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="padding-vertical padding-xhuge">
                <div className="row">
                  <div className="col-md-6 layout353_content-left">
                    <div>
                      <h2 className="heading-xxlarge sixreasonstitle">6 Reasons to choose Trademark Registration</h2>
                      <p className="text-size-large sixreasonspara">Here are the major reasons why people opt for Trademark Registration:</p>
                  ...
                  <div className="col-md-6  layout353_content-right">
                    <div className="layout353_content-item content-item-1 sticky">
                      ...
                      <div>
                        <h5>Protection against imitators</h5>
                      </div>
                    </div>
                    <div className="layout353_content-item content-item-2 sticky">
                      ...
                      <div>
                        <h5>Helps to build the image and credibility of a brand</h5>
                      </div>
                    </div>
                    <div className="layout353_content-item content-item-3 sticky">
                      ...
                      <div>
                        <h5>Making growth and expansion possible</h5>
                      </div>
                    </div>
          ...
          <div className="head_sec ">
            <div className="row align-items-center">
              <div className="col-lg-10 col-sm-12 ">
                <h2 className="criteriatitle">Trademark Registration<br /> made easy!</h2>
          ...
          <div className="tab-content">
            <div className={`tab-pane ${activeTab === 'tabs-1' ? 'active' : ''}`} id="tabs-1" role="tabpanel">
              <div className="round_box criteriabox ms-auto bg-white">
                <li className="p_rel">✔ Any individual or company can apply for a trademark so that their product or service can be protected. The application must include the trademark, the applicant's name and address, as well as the agent and the power of attorney.</li>
            ...
            <div className={`tab-pane ${activeTab === 'tabs-2' ? 'active' : ''}`} id="tabs-2" role="tabpanel">
              <div className="bg-white criteriabox">
                ...
                <li className="p_rel">✔ Proof of Applicant</li>
                <li className="p_rel">✔ Brand name and logo</li>
                <li className="p_rel">✔ User Affidavit</li>
                <li className="p_rel">✔ Proof of TM use</li>
                <li className="p_rel">✔ MSME/Startup Recognition</li>
                <li className="p_rel">✔ Signed form TM-48</li>
            ...
            <div className={`tab-pane ${activeTab === 'tabs-3' ? 'active' : ''}`} id="tabs-3" role="tabpanel">
              <div className="steps criteriabox bg-white">
                <div className="step ">
                  <div >
                    <li><b>Step 1:</b> Trademark Search</li>
                    <li><b>Step 2:</b> Selection of Classes</li>
                    <li><b>Step 3:</b> Application filing (Get ™ number)</li>
                    <li><b>Step 4:</b> Use ™ symbol</li>
                    <li><b>Step 5:</b> Application processing begins</li>
                    <li><b>Step 6:</b> Objection on the Trademark Application</li>
                    <li><b>Step 7:</b> Hearing</li>
