      ...
      <main>
        <div className="herocontainer">
          ...
          <section className="contact-form">
            ...
            <h2 className="formplctitle text-center">Proprietorship To Pvt Ltd</h2>
          ...
          <div className="hero-text herocontent">
            <h1 className="herotitle">Growing your business: From a sole proprietorship to a corporation</h1>
            <p className="heropara">Many business owners in India start by setting up sole proprietorships due to the low compliance requirements. The growth of the company results in an increase in revenues.</p>
          </div>
        </div>
      </main>
            ...
            <div>
              <div className="help_txt">
                ...
                <div className="text-left">
                    <li>A sole proprietorship could easily be transformed into a private limited company in order to reduce liability and to separate the bank accounts and tax filing of an individual.</li>
                </div>
              </div>
            </div>
              ...
              <div className="padding-vertical padding-xhuge">
                <div className="row">
                  <div className="col-md-6 layout353_content-left">
                    <div>
                      <h2 className="heading-xxlarge sixreasonstitle">4 Reasons to convert your sole proprietorship into a private company</h2>
                      <p className="text-size-large sixreasonspara">Here are the main reasons:</p>
                  ...
                  <div className="col-md-6  layout353_content-right">
                    <div className="layout353_content-item content-item-1 sticky">
                      ...
                      <div>
                        <h5>Unlimited fundraising options</h5>
                      </div>
                    </div>
                    <div className="layout353_content-item content-item-2 sticky">
                      ...
                      <div>
                        <h5>Increased customer base = Increased financial credibility</h5>
                      </div>
                    </div>
                    <div className="layout353_content-item content-item-3 sticky">
                      ...
                      <div>
                        <h5>Protect personal assets and limit liabilities</h5>
                      </div>
                    </div>
                    <div className="layout353_content-item content-item-4 sticky">
                      ...
                      <div>
                        <h5>Free yourself from the limitations of a sole proprietorship</h5>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="container criteriacontainer">
          <div className="head_sec ">
            <div className="row align-items-center">
              <div className="col-lg-10 col-sm-12 ">
                <h2 className="criteriatitle">Converting your Proprietorship into a Privated Limited Company<br /> made easy!</h2>
          ...
          <div className="tab-content">
            <div className={`tab-pane ${activeTab === 'tabs-1' ? 'active' : ''}`} id="tabs-1" role="tabpanel">
              ...
              <li><b>You need the following to turn your business into a private company</b></li>
              <li className="p_rel">✔ Two directors</li>
                <li className="p_rel">✔ Authorised capital of ₹1 lakh</li>
                <li className="p_rel">✔ Registered office</li>
                <li className="p_rel">✔ Memorandum of association</li>
                <li className="p_rel">✔ Annual returns</li>
              </div>
            </div>
            <div className={`tab-pane ${activeTab === 'tabs-2' ? 'active' : ''}`} id="tabs-2" role="tabpanel">
              <div className="bg-white criteriabox">
              
                <li className="p_rel">✔ ID and address proof</li>
                <li className="p_rel">✔ Registered office proof</li>
                <li className="p_rel">✔ E-Form spice 32</li>
            ...
            <div className={`tab-pane ${activeTab === 'tabs-3' ? 'active' : ''}`} id="tabs-3" role="tabpanel">
              <div className="steps criteriabox bg-white">
                <div className="step ">
                  <div >
                    <li><b>For voluntary winding up:</b></li>
                    ...
                    <li><b>Step 3:</b> Application for the name availability</li>
                    <li><b>Step 4:</b> Filing of the EMOA and EAOA to register a private limited company</li>
                    ...
                    <li><b>Step 7:</b> Opening a current bank account on the company name</li>
