      ...
      <main>
        <div className="herocontainer">
          ...
          <section className="contact-form">
            ...
            <h2 className="formplctitle text-center">Change in Company Name</h2>
          ...
          <div className="hero-text herocontent">
            <h1 className="herotitle mb-4">Change in the company name: A new look for the business</h1>
            <p className="heropara ">Sometimes a company's name just doesn't feel right or work well for the company; other times, it might be necessary to change the name to separate yourself from a bad reputation. In such cases, you can rename your business to something more appropriate for your long-term goals.</p>
          </div>
        </div>
      </main>
          ...
          <div className="row align-items-center bg_white_box">
            <div>
              <div className="help_txt">
                ...
                Would changing the company name affect my business?
                </h2>
                
                <div className="text-left">
                    <li>Changing the name of your company will not affect the rights and obligations associated with your business.
While new legal actions taken against the company would need to be brought under the new name, legal actions already brought against the company under the old name could be continued.</li>
              ...
              <div className="padding-vertical padding-xhuge">
                <div className="row">
                  <div className="col-md-6 layout353_content-left">
                    <div>
                      <h2 className="heading-xxlarge sixreasonstitle">6 reasons why companies choose to change their names:</h2>
                  ...
                  <div className="col-md-6  layout353_content-right">
                    <div className="layout353_content-item content-item-1 sticky">
                      ...
                      <div>
                        <h5>Choosing something catchy</h5>
                      </div>
                    </div>
                    <div className="layout353_content-item content-item-2 sticky">
                      ...
                      <div>
                        <h5>Repositioning of the brand</h5>
                      </div>
                    </div>
                    <div className="layout353_content-item content-item-3 sticky">
                      ...
                      <div>
                        <h5>Capitalising on the popularity of a product/service</h5>
                      </div>
                    </div>
        ...
        <div className="container criteriacontainer">
          <div className="head_sec ">
            <div className="row align-items-center">
              <div className="col-lg-10 col-sm-12 ">
                <h2 className="criteriatitle">Company name change<br /> made easy!</h2>
          ...
          <ul className="nav  nav-tabs criteriatabs me-auto" role="tablist">
            <li className="nav-item">
              <button className={`nav-link criteriabtn ${activeTab === 'tabs-1' ? 'active' : ''}`} onClick={() => handleTabClick('tabs-1')} role="tab">Document Required</button>
            </li>
            <li className="nav-item">
          ...
          <div className="tab-content">
            <div className={`tab-pane ${activeTab === 'tabs-1' ? 'active' : ''}`} id="tabs-1" role="tabpanel">
              ...
              <li>✔ Form MGT-1 </li>
              <li>✔ Notice of the EGM </li>
              <li>✔ Certified copy of the special resolution passed in the EGM </li>
              <li>✔ The explanatory statement to EGM </li>
              <li>✔ Copy of altered MoA and AoA with the new company name </li>
              <li>✔ A certified true copy of the minutes of the EGM </li>
              <li className="mb-3">✔ Copy of any approval order received from the other authorities such as IRDA, SEBI, RBI, etc., if any </li>
              <li>Copy of resolution agreement mentioning the members voting for and against the resolution</li>
                
              </div>
            </div>
            <div className={`tab-pane ${activeTab === 'tabs-2' ? 'active' : ''}`} id="tabs-2" role="tabpanel">
              <div className="bg-white criteriabox">
              <li><b>Within local limits:</b></li>
              <li><b>Step 1:</b> Adopting a Board Resolution</li>
                    <li className="mt-2"> A resolution to change the company's name must be approved by the board of directors at a meeting. They should then designate one of them or the company secretary (CS) to contact the MCA to inquire about the name's availability.</li>
                    <li><b>Step 2:</b> Verifying Name Availability</li>
                    <li className="mt-2"> To check the availability of the proposed name, the authorized person should submit a form INC-1 to the MCA. It's crucial to conduct a trademark search for the suggested name.
Prior to determining their availability, it is advised that you shortlist four to five potential names to cover any chances of them already being taken or in use.</li>
                    <li><b>Step 3:</b> Adopting a Special Resolution</li>
                    <li className="mt-2"> A special general meeting (EGM) should be called by the company once the new name's availability has been verified. To change the name and make the necessary adjustments to the AoA and the MoA, a special resolution will be passed.</li>
                    <li><b>Step 4:</b> Submitting an application to the Registrar</li>
                    <li className="mt-2">After being passed, the special resolution must be submitted to the ROC along with the form MGT-14, which contains information about it.</li>
                    <li className="mt-2">Form INC-24 must be submitted to ROC along with the required fee within 30 days of submitting the MGT-14. This is necessary in order to get the central government's approval for the name change.</li>
                    <li><b>Step 5:</b> Issuing the Certificate of Incorporation</li>
                    <li className="mt-2">The ROC will issue a new certificate of incorporation reflecting the name change once it is satisfied that all requirements of the application and supporting documents have been met.</li>
