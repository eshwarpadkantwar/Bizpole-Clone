      ...
      <main>
        <div className="herocontainer">
          ...
          <section className="contact-form">
            ...
            <h2 className="formplctitle text-center">PAN Application</h2>
          ...
          <div className="hero-text herocontent">
            <h1 className="herotitle">Simplify your PAN process</h1>
            <p className="heropara">In order to simplify your tax return filing process and make it easier for you, we help you get your PAN number. Our team of experts are always available to help you with their extensive knowledge and experience in handling your tax matters. Get the advantage of our services today!</p>
          </div>
        </div>
      </main>
          ...
          <div className="row align-items-center bg_white_box">
            <div>
              <div className="help_txt">
                ...
                <h6 className="mt-3">You need a PAN to:</h6>
                <div className="text-left">
                    <li>a) File IT returns</li>
                    <li>b) Open a bank account</li>
                    <li>c) Apply for a debit or credit card</li>
                    <li>d) Apply for a loan</li>
                    <li>e) Open a fixed deposit</li>
                    <li>f) For insurance payments</li>
              ...
              <div className="padding-vertical padding-xhuge">
                <div className="row">
                  <div className="col-md-6 layout353_content-left">
                    <div>
                      <h2 className="heading-xxlarge sixreasonstitle">5 Reasons to opt for PAN Application</h2>
                  ...
                  <div className="col-md-6  layout353_content-right">
                    ...
                    <div className="layout353_content-item content-item-3 sticky">
                      ...
                      <div>
                        <h5>Necessary to claim a tax refund</h5>
                      </div>
                    </div>
                    <div className="layout353_content-item content-item-4 sticky">
                      ...
                      <div>
                        <h5>Foreign travels, hotel bills, purchase of goods and services etc all above Rs. 50000 need a PAN card</h5>
                      </div>
                    </div>
                    <div className="layout353_content-item content-item-3 sticky">
                      <div className="text-size-large sixreasonsnum text-weight-bold text-color-accent">05</div>
                      <div>
                        <h5>PAN is mandatory for filing ITR. Deductees without PAN are subject to a higher rate of TDS.</h5>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="head_sec ">
            <div className="row align-items-center">
              <div className="col-lg-10 col-sm-12 ">
                <h2 className="criteriatitle">PAN Application<br /> made easy!</h2>
          ...
          <div className="tab-content">
            <div className={`tab-pane ${activeTab === 'tabs-1' ? 'active' : ''}`} id="tabs-1" role="tabpanel">
              <div className="round_box criteriabox ms-auto bg-white">
                <li className="p_rel">✔ ID proof </li>
                <li className="p_rel">✔ Address proof</li>
                <li className="p_rel">✔ DOB proof </li>
                <li className="p_rel">✔ Certificate of Registration for companies</li>
                
              </div>
            </div>
            <div className={`tab-pane ${activeTab === 'tabs-2' ? 'active' : ''}`} id="tabs-2" role="tabpanel">
              <div className="bg-white criteriabox">
                <li className="mb-3"><b>4 easy steps to register a PAN</b></li>
              <li><b>Step 1:</b> Visit the portal Visit the NSDL website online and submit the captcha. A token is then generated that helps you proceed with the PAN application</li>
                    <li><b>Step 2:</b> Submit documents You now need to submit the necessary proof documents either digitally using e-KYC and e-sign, or scanned images via e-sign.</li>
                    <li><b>Step 3:</b> Get an Assessing Officer code In order to understand your tax jurisdiction, details need to be filled in so you can be assigned an Assessing Officer code.</li>
                    <li><b>Step 4:</b> Photo and ID proof Lastly, you will need to upload your photograph and signature and submit the form.</li>
              </div>
            </div>
